	...
	tbl2.style.display='none';
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="990" align="center">
            ...
            <tr height="20">
                ...
                <a class="menuButton" href="historicos.cfm" onclick="return buttonClick(event, 'historico');" onmouseover="buttonMouseover(event, 'historico');">Histórico de llamadas</a>
            ...
            <tr height="600" valign="middle">
              ...
              <table width="100%" bgcolor="#DFE4F4" cellpadding="5">
                ...
                <tr>
					...
					<td align="left" ><input name="Persona" type="text" class="micontrol" id="Persona" size="65" onKeyUp="this.value=this.value.toUpperCase();"/>
                    				<input name="IdPersona" type="hidden" class="micontrol" id="IdPersona" size="1" />
					  <input type="submit" name="Preconsulta" id="Preconsulta" value="Buscar..." onclick="visible('tabla2')"/></td>
