...
<body>   
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="990" align="center">
            ...
            <tr height="20">
                ...
                <a class="menuButton" onclick="return buttonClick(event, 'fichero');" onmouseover="buttonMouseover(event, 'fichero');">Fichero</a>
...
<form action="modifica.cfm" method="post" name="form2" id="form2" width="980">
<tr>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td><button id="Modificar" name="Modificar">&nbsp;&nbsp;&nbsp;Modificar&nbsp;&nbsp;&nbsp;</button></td>
</form>
</table>
</td>
</tr>
