...
<body>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="990" align="center">
			...
			<cfset variables.Result = StructDelete(session, "varsQuery")>
              ...
              <table width="100%" bgcolor="#DFE4F4" cellpadding="8">
                <tr>
                  ...
                  <td width="57%" align="left"><input name="Nombre" type="text" class="micontrol" id="Nombre" size="65" onKeyUp="this.value=this.value.toUpperCase();"/></td>
                   <td width="13%">&nbsp;</td>
                </tr>
					<tr>
					  <td align="left" >Apellido:</td>
					  <td align="left" ><input name="Apellido" type="text" class="micontrol" id="Apellido" size="65" onKeyUp="this.value=this.value.toUpperCase();"/></td>
					  <td>&nbsp;</td>
			    <tr>
				  <td align="left" >Instancia:</td>
				  <td align="left" ><input name="Instancia" type="text" class="micontrol" id="Instancia" size="65" onKeyUp="this.value=this.value.toUpperCase();"/></td>
                  <td>&nbsp;</td>
